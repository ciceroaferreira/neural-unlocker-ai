          ...
          <div className="relative w-48 h-48 sm:w-64 sm:h-64 mb-4 sm:mb-6 flex items-center justify-center">
            ...
            {introStep === 'initial' && (
              <button onClick={handlePlayIntro} className="absolute inset-0 flex items-center justify-center group cursor-pointer">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-indigo-600/20 rounded-full flex items-center justify-center border border-indigo-500/30 hover:scale-110 transition-all duration-500 animate-bounce">
          ...
          <div className="w-full max-w-md space-y-3 sm:space-y-4">
            {introStep === 'ready' && (
              <button
                ...
                className="group relative w-full py-6 sm:py-10 rounded-[2rem] sm:rounded-[2.5rem] font-black text-lg sm:text-2xl transition-all bg-indigo-600 hover:bg-indigo-500 shadow-[0_0_50px_rgba(79,70,229,0.3)] overflow-hidden flex items-center justify-center gap-4 sm:gap-6 animate-in zoom-in-95 duration-700"
              >
